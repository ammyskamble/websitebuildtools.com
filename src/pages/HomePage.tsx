          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="glass-card rounded-xl p-5 border border-dark-border space-y-2">
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  Drag and drop an existing PNG, JPG, or SVG file, or use our <strong>icon maker</strong> and Gemini AI Prompt Studio to craft a brand-new vector from scratch.
                </p>
              </div>
