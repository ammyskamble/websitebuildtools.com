      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="glass-card rounded-2xl p-6 border border-dark-border flex flex-col justify-between group hover:border-violet-500/50 transition-all">
            ...
            <div className="mt-6 pt-4 border-t border-dark-border/60 flex items-center justify-between">
              <span className="text-[11px] text-violet-600 dark:text-violet-400 font-semibold">Visual Diff & Stats</span>
              <Link
                to="/tools/svg-optimizer"
          ...
          <div className="glass-card rounded-2xl p-6 border border-dark-border flex flex-col justify-between group hover:border-blue-500/50 transition-all">
            ...
            <div className="mt-6 pt-4 border-t border-dark-border/60 flex items-center justify-between">
              <span className="text-[11px] text-blue-600 dark:text-blue-400 font-semibold">Batch Drag & Drop</span>
              <Link
        ...
        <div className="mt-6 grid grid-cols-2 sm:grid-cols-5 gap-3">
          ...
          <Link
            ...
            className="p-3.5 rounded-xl glass-card border border-dark-border hover:border-brand-500/40 transition-colors text-center"
          >
            <span className="text-xs font-bold text-slate-900 dark:text-white block">SVG to JPG</span>
            <span className="text-[10px] text-slate-500 dark:text-slate-400">Quality compression</span>
          </Link>
          <Link
            to="/convert/svg-to-ico"
            className="p-3.5 rounded-xl glass-card border border-dark-border hover:border-brand-500/40 transition-colors text-center"
          >
            <span className="text-xs font-bold text-slate-900 dark:text-white block">SVG to ICO</span>
            <span className="text-[10px] text-slate-500 dark:text-slate-400">Multi-size embedded</span>
          </Link>
          <Link
          ...
          >
            <span className="text-xs font-bold text-slate-900 dark:text-white block">SVG to Data URI</span>
            <span className="text-[10px] text-slate-500 dark:text-slate-400">CSS & Base64</span>
          </Link>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <article className="glass-panel rounded-3xl p-8 sm:p-12 lg:p-16 border border-dark-border space-y-12 text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-2 pt-2 border-b border-dark-border/60 pb-8">
            <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-dark-card border border-dark-border text-xs text-slate-700 dark:text-slate-300 flex items-center gap-1.5">🇺🇸 United States</span>
            <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-dark-card border border-dark-border text-xs text-slate-700 dark:text-slate-300 flex items-center gap-1.5">🇮🇳 India</span>
            <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-dark-card border border-dark-border text-xs text-slate-700 dark:text-slate-300 flex items-center gap-1.5">🇩🇪 Deutschland (Germany)</span>
            <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-dark-card border border-dark-border text-xs text-slate-700 dark:text-slate-300 flex items-center gap-1.5">🇫🇷 France</span>
            <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-dark-card border border-dark-border text-xs text-slate-700 dark:text-slate-300 flex items-center gap-1.5">🇨🇦 Canada</span>
            <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-dark-card border border-dark-border text-xs text-slate-700 dark:text-slate-300 flex items-center gap-1.5">🇦🇺 Australia</span>
            <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-dark-card border border-dark-border text-xs text-slate-700 dark:text-slate-300 flex items-center gap-1.5">🇧🇷 Brasil (Brazil)</span>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-slate-100/70 dark:bg-dark-surface/60 border border-dark-border">
                <h4 className="font-semibold text-slate-900 dark:text-white text-sm">1. The Classic favicon.ico Binary Container</h4>
              ...
              <div className="p-4 rounded-xl bg-slate-100/70 dark:bg-dark-surface/60 border border-dark-border">
                <h4 className="font-semibold text-slate-900 dark:text-white text-sm">2. Modern Vector favicon.svg with Dark Mode Media Queries</h4>
                <p className="text-xs text-slate-600 dark:text-slate-400 mt-1 leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="glass-card rounded-xl p-5 border border-dark-border space-y-2">
                <span className="text-xs font-bold text-brand-600 dark:text-brand-400">Step 1</span>
                <h5 className="font-bold text-slate-900 dark:text-white text-sm">Choose Your Source</h5>
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              <div className="glass-card rounded-xl p-5 border border-dark-border space-y-2">
                ...
                <h5 className="font-bold text-slate-900 dark:text-white text-sm">Adjust Precision & Smoothing</h5>
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              <div className="glass-card rounded-xl p-5 border border-dark-border space-y-2">
                ...
                <h5 className="font-bold text-slate-900 dark:text-white text-sm">Select Your Export Format</h5>
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              <div className="glass-card rounded-xl p-5 border border-dark-border space-y-2">
                <span className="text-xs font-bold text-emerald-600 dark:text-emerald-400">Step 4</span>
                <h5 className="font-bold text-slate-900 dark:text-white text-sm">Deploy with Zero Hassle</h5>
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
