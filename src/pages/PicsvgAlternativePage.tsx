  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
      ...
      <section className="text-center space-y-4 max-w-4xl mx-auto">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-500/10 border border-brand-500/30 text-xs font-semibold text-brand-600 dark:text-brand-300">
        ...
        {/* Trust Badges */}
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 pt-2 text-xs text-slate-700 dark:text-slate-300 font-medium">
          <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400" /> No Files Stored on Servers</span>
          <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400" /> No 4 MB Limit</span>
          <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400" /> Cricut & Laser Cut Ready</span>
          <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400" /> 100% Free & Ad-Free</span>
        </div>
      </section>
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-slate-600 dark:text-slate-400 hidden sm:inline">Drag & drop any image to test live</span>
        </div>
      ...
      <section className="glass-panel rounded-3xl p-6 sm:p-10 border border-dark-border space-y-6">
        <div className="max-w-3xl">
          <span className="text-xs font-bold text-brand-600 dark:text-brand-400 uppercase tracking-wider block mb-2">
            Detailed Comparison
          </span>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[600px]">
            <thead>
              <tr className="border-b border-slate-200 dark:border-dark-border text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400">
                <th className="py-3.5 px-4 font-semibold">Feature / Capability</th>
                <th className="py-3.5 px-4 font-semibold text-brand-600 dark:text-brand-400 bg-brand-500/10 rounded-t-xl">
                  SvgFav.com (Modern)
                </th>
                <th className="py-3.5 px-4 font-semibold text-slate-500 dark:text-slate-400">Picsvg (Legacy)</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-200 dark:divide-dark-border/60 text-xs">
              {comparisonRows.map((row, idx) => (
                <tr key={idx} className="hover:bg-slate-100/50 dark:hover:bg-dark-surface/40 transition-colors">
                  <td className="py-4 px-4 font-medium text-slate-900 dark:text-white">{row.feature}</td>
                  <td className="py-4 px-4 text-emerald-700 dark:text-emerald-300 font-semibold bg-brand-500/5">
                  ...
                  <td className="py-4 px-4 text-slate-600 dark:text-slate-400">
                    <div className="flex items-center gap-2">
                      <X className="w-4 h-4 text-rose-500 dark:text-rose-400 shrink-0" />
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="glass-card rounded-2xl p-6 border border-dark-border space-y-3">
          ...
          <h3 className="font-bold text-slate-900 dark:text-white text-base">100% Client-Side Privacy</h3>
        ...
        <div className="glass-card rounded-2xl p-6 border border-dark-border space-y-3">
          ...
          <h3 className="font-bold text-slate-900 dark:text-white text-base">No 4MB Size Restriction</h3>
          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <div className="glass-card rounded-2xl p-6 border border-dark-border space-y-3">
          ...
          <h3 className="font-bold text-slate-900 dark:text-white text-base">Cricut & Laser Ready</h3>
          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <div className="glass-card rounded-2xl p-6 border border-dark-border space-y-3">
          ...
          <h3 className="font-bold text-slate-900 dark:text-white text-base">All-in-One Studio Suite</h3>
          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
      ...
      <section className="glass-panel rounded-3xl p-8 sm:p-12 border border-dark-border space-y-6">
        <div className="max-w-3xl space-y-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-500/10 border border-violet-500/20 text-xs font-semibold text-violet-600 dark:text-violet-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
          <div className="glass-card rounded-2xl p-5 border border-dark-border space-y-2">
            <h4 className="font-bold text-slate-900 dark:text-white text-sm">1. Zero Path Fragmentation</h4>
          ...
          <div className="glass-card rounded-2xl p-5 border border-dark-border space-y-2">
            <h4 className="font-bold text-slate-900 dark:text-white text-sm">2. Adjustable Tolerance</h4>
            <p className="text-xs text-slate-600 dark:text-slate-400">
          ...
          <div className="glass-card rounded-2xl p-5 border border-dark-border space-y-2">
            <h4 className="font-bold text-slate-900 dark:text-white text-sm">3. Instant SVG Download</h4>
            <p className="text-xs text-slate-600 dark:text-slate-400">
              Standard compliant XML with <code className="text-brand-600 dark:text-brand-300">viewBox</code> attributes that import seamlessly without scaling errors.
            </p>
          </div>
        </div>
      </section>
