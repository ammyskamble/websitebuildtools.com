      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-5">
          ...
          <div className="glass-panel rounded-2xl p-5 border border-dark-border space-y-4">
            <div className="flex items-center justify-between">
              ...
              <label className="text-xs text-brand-400 hover:text-brand-300 font-medium cursor-pointer underline flex items-center gap-1">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="glass-card rounded-2xl p-5 border border-dark-border space-y-3">
            ...
            <pre className="p-3.5 rounded-xl bg-dark-bg/90 border border-dark-border text-[11px] font-mono text-slate-300 overflow-x-auto leading-relaxed">
              {headSnippet}
            </pre>
          </div>
        </div>
